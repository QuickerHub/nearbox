...
/** Project folders on the PC that agents are allowed to work in. */
export function ProjectsView({ snapshot, client }: ProjectsViewProps): JSX.Element {
    ...
    <section className="screen projects">
      <div className="screen__scroll">
        <div className="inbox__intro">
          <h2>项目</h2>
          <p className="muted">Agent 只会在这里登记过的目录里工作。派发任务时从这里选一个。</p>
        </div>
        ...
        {projects.length === 0 ? (
          <EmptyState title="还没有项目" body="添加一个代码目录后，就能把任务派给 Agent 去做。" />
        ) : (
